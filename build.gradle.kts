...
loom {
    launchConfigs {
        "client" {
            ...
            arg("-Dfml.coreMods.load", "com.mylk.charmonium.transformer.FMLCore")
            arg("--tweakClass", "com.mylk.charmonium.transformer.Tweaker")
        }
    }
    forge {
...
dependencies {
    ...
    forge("net.minecraftforge:forge:1.20.4-49.0.32")
...
tasks.withType(Jar::class) {
    ...
    manifest.attributes.run {
        this["FMLCorePlugin"] = "com.mylk.charmonium.transformer.FMLCore"

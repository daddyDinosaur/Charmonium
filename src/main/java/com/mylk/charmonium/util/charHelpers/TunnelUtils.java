...
public class TunnelUtils {
    ...
    public static void updateListData(HashSet<BlockPos> broken) {
        ...
        tmp.removeIf(b ->
                ...
                getPossibleLocDefault(mc.thePlayer.getPositionVector(), b, new Block[] { Blocks.air, Blocks.bedrock }) == null);
    ...
    private static List<BlockPos> getVeinAround(BlockPos posAround, int addX, int addY, int addZ) {
        return getBlocksInRadius(
                ...
                addZ,
                posAround,
                new Block[] { Blocks.hardened_clay, Blocks.double_stone_slab2, Blocks.stained_hardened_clay }
        );
    }

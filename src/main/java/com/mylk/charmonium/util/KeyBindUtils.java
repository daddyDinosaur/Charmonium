...
import com.mylk.charmonium.feature.impl.AntiStuck;
...
public class KeyBindUtils {
    ...
    public static HashSet<KeyBinding> getNeededKeyPressesHash(final Vec3 from, final Vec3 to) {
        ...
        final pathingRotations.Rotation neededRot = pathingRotations.getNeededChange(pathingRotations.getRotation(from, to));

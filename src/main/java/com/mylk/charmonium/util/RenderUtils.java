...
import com.mylk.charmonium.mixin.render.RenderManagerAccessor;
...
public class RenderUtils {
    ...
    public static void drawCoordsRoute(List<BlockPos> coords, RenderWorldLastEvent event, Color color) {
        ...
        for (int i = 0; i < coords.size() - 1; i++) {
            ...
            drawLine(bufferBuilder, pos, nextPos, color);
        }
    ...
    private static void drawLine(WorldRenderer bufferBuilder, BlockPos pos, BlockPos nextPos, Color color) {
        bufferBuilder.pos(pos.getX() + 0.5f, pos.getY() + 0.5f, pos.getZ() + 0.5f).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()).endVertex();
        bufferBuilder.pos(nextPos.getX() + 0.5f, nextPos.getY() + 0.5f, nextPos.getZ() + 0.5f).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()).endVertex();
    }

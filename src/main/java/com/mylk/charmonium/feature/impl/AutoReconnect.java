    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        switch (state) {
            ...
            case CONNECTING:
                ...
                if (reconnectDelay.passed()) {
                    try {
                        ...
                        Notifications.INSTANCE.send("Charmonium", "Failed to reconnect to server! Trying again in 5 seconds...");
            ...
            case LOBBY:
                ...
                if (GameStateHandler.getInstance().getLocation() == GameStateHandler.Location.LOBBY || !GameStateHandler.getInstance().atProperIsland()) {

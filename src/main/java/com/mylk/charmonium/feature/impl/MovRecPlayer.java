...
import com.mylk.charmonium.util.OldRotationUtils;
...
public class MovRecPlayer implements IFeature {
    ...
    public MovRecPlayer() {
        ...
        try {
            resourceFiles = getResourceFiles("/charmonium/movrec");
            ...
            for (String file : resourceFiles) {
                ...
                InputStream inputStream = Charmonium.class.getResourceAsStream(file);
...
//        LogUtils.sendSuccess("easeTo: " + (movement.yaw + yawDifference));
    ...
    private List<String> getResourceFiles(String path) throws IOException {
        ...
        FileSystem fs;
        URL url = Charmonium.class.getResource(path);
        if (url == null) {
            return filenames;
        }
        try {
            ...
            if ("file".equals(uri.getScheme())) {
                myPath = Paths.get(Objects.requireNonNull(Charmonium.class.getResource(path)).toURI());
            } else {

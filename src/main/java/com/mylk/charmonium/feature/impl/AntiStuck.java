...
import com.mylk.charmonium.failsafe.impl.TeleportFailsafe;
...
public class AntiStuck implements IFeature {
    ...
    public void stop() {
        ...
        long randomTime = Config.getRandomTimeBetweenChangingRows();
        if (randomTime < 350) {
            randomTime = 350;
        }
    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        if (!MacroHandler.getInstance().isMacroToggled() ||
                ...
                !GameStateHandler.getInstance().atProperIsland()) {
            return;
        }
